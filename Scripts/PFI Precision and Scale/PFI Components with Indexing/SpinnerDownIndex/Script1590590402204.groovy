...
//Component Name: SpinnerDownIndex
...
counterUp = WebUI.modifyObjectProperty(findTestObject('Objects.CounterValidation/counter_icon_up'), 'xpath', 'equals', ('(//*[contains(@class,\'x-form-spinner-down\')])[' + 
    indexDown) + ']', true)
...
if (NewValue != 0) {
	...
	WebUI.verifyLessThan(NewValue, GetCurrentValue, FailureHandling.STOP_ON_FAILURE)

}else{

	WebUI.comment('No negative integers')
}
