...
/*==========================================================================*
 * COMPONENT NAME: PFIRadioButtonHashmap		                  				*
 * TESTER: Krizia Manuel                                           			*
 * CREATE DATE: 30-July-2020                                       			*
 * PURPOSE: To verify the radio button against the URS 						*
 * =========================================================================*
 */
...
switch (Name) {
		case 'MainForm':
		GlobalVariable.ValueFound = RadioButtonTBL.find { it.value.MainForm == FindValue }
			break
