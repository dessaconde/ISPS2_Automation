...
WebUI.callTestCase(findTestCase('Components/ClickBlueButtons'), [('buttonText') : 'OK'], FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('Components/Wait'), [('secondsToWait') : 1000], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ManipulateExpiryDate'), [('inOnOption') : 'on', ('noOfDays') : '12', ('periodType') : 'Month(s)'
        , ('expiryDate') : '19/02/2020'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ManipulateClausesToBeIncluded'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateIssueWD'), [('ESSExpiryDate') : '19/02/2020', ('ESSComment') : 'ESS Comment field automated populate test. '], 
