...
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Reject/Disapproval'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/Wait'), [('secondsToWait') : 3000], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateReject'), [('Remarks') : 'Remarks field automated populate test. ', ('ESSExpiryDate') : '19/03/2020'
        , ('ESSComment') : 'ESS Comment field automated populate test. '], FailureHandling.STOP_ON_FAILURE)
