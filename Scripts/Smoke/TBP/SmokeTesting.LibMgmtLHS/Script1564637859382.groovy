...
WebUI.callTestCase(findTestCase('Components/NavigateToLibMgmtLHS'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClosePopUpWindow'), [:], FailureHandling.STOP_ON_FAILURE)
