...
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Generate Correspondence'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateGenerateCorrespondence'), [('Remarks') : 'Remarks field automated populate test. '
