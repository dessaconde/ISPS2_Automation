...
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Builder'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateBuilder'), [('Salutation') : findTestData('Datatable').getValue('Salutation', 
            1), ('IDType') : findTestData('Datatable').getValue('IDType', 1), ('FirmName') : findTestData('Datatable').getValue(
            'FirmName', 1), ('Designation') : findTestData('Datatable').getValue('Designation', 1), ('Name') : findTestData(
            'Datatable').getValue('Name', 1), ('IDNo') : findTestData('Datatable').getValue('IDNo', 1), ('UEN') : findTestData(
            'Datatable').getValue('UEN', 1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClickResetButtonII'), [:], FailureHandling.STOP_ON_FAILURE)
