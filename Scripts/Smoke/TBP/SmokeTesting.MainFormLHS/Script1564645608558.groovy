...
WebUI.callTestCase(findTestCase('Components/NavigateToMainFormLHS'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/SelectTypeOfApplication'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateDurationApproved'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifySuccessfulSavedChanges'), [:], FailureHandling.CONTINUE_ON_FAILURE)
