...
WebUI.callTestCase(findTestCase('Components/PopulateCloseCaseLHS'), [('ProjectEnded') : 'Yes', ('TempBldgStatus') : 'Regularize'
        , ('Remarks') : 'Remarks field automated population test. '], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClickBlueButtons'), [('buttonText') : 'Close Case'], FailureHandling.STOP_ON_FAILURE)
