...
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Issue Withdrawal Letter'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateIssueWithdrawalLetter'), [('Remarks') : 'Remarks field automated populate test. '
