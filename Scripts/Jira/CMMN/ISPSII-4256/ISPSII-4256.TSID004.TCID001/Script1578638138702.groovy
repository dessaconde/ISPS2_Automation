...
WebUI.callTestCase(findTestCase('Components/ReassignCaseFromMyTask'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseReassignment'), [:], FailureHandling.STOP_ON_FAILURE)
