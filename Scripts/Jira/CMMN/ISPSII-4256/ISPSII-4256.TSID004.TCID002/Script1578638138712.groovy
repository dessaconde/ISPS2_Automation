...
WebUI.callTestCase(findTestCase('Components/ReassignCaseFromMyTask'), [('extractedCaseRefNo') : '\r\n', ('formattedTime') : ''], 
...
WebUI.callTestCase(findTestCase('Components/SelectItemFromAuditTrailTable'), [('LinkToModify') : 'Reassigned to officer successfully.'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/VerifyFunctionSubFunctionRenamed (EAT-RC)'), [:], FailureHandling.STOP_ON_FAILURE)
