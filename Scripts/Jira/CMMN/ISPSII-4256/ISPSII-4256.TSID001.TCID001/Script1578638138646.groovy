...
WebUI.callTestCase(findTestCase('Components/PopulateUserInformation'), [('Name') : 'Rhodessa Conde', ('Status') : 'ACTIVE'
        , ('UserID') : 'RHOD'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateSecurityInformation'), [('Password') : findTestData('Datatable').getValue(
            'Password', 3), ('ConfirmPassword') : findTestData('Datatable').getValue('Password', 3)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClickAddWorkload'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/PopulateNewWorkload'), [('Module') : 'CM', ('Application') : 'Correspondence to agency (ESS-CORR)'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/UploadImage'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/SelectItemFromAuditTrailTable'), [('LinkToModify') : 'CM : Manage User : Profile image updated successfully'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClickCloseButton'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/SelectItemFromAuditTrailTable'), [('LinkToModify') : 'CM : Manage User : Workload created successfully'], 
    FailureHandling.STOP_ON_FAILURE)
