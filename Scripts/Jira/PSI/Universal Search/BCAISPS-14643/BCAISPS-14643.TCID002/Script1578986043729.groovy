...
'Search for Process Case (SMAH).'
WebUI.callTestCase(findTestCase('Components/Filter'), [('taskDescription') : 'Process Case (SMAH)'], FailureHandling.STOP_ON_FAILURE)

'Select a case from the filtered case type.'
WebUI.callTestCase(findTestCase('Components/SelectItemFromFilteredTasks'), [('Index') : '4', ('extractedCaseTypeFromGV') : GlobalVariable.caseType], 
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStatusInUniversalSearch'), [('caseTypeCaseStatus') : 'PSI Adhoc Processing | CLOSED'
        , ('caseStatus') : 'SM AD HOC CASE CLOSED'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStageFromUniversalSearch'), [('caseOptions') : 'View Case Stages', ('applicationType') : 'PSI Audit Processing'
        , ('officer') : 'System Administrator', ('stageDesc') : 'SM AD HOC CASE CLOSED', ('caseStat') : 'SM Adhoc Case Closed'], 
    FailureHandling.STOP_ON_FAILURE)
