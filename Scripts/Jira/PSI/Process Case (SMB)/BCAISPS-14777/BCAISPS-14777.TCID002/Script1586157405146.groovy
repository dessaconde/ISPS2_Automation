...
'Manipulate case config'
WebUI.callTestCase(findTestCase('Components/ManipulateCaseDurationConfig'), [('caseDuration') : '5', ('moduleName') : 'EBNS'
...
WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'psiRecommendTo'
        , ('textToBeInputted') : 'Lim Beng'], FailureHandling.STOP_ON_FAILURE)
...
'Login as the recommended officer.'
WebUI.callTestCase(findTestCase('null'), [('LinkToBeUsed') : findTestData('Datatable').getValue('URL', 2)
        , ('LoginPageTextToBeVerified') : findTestData('Datatable').getValue('HomeBanner', 2), ('Username') : findTestData('Datatable').getValue('Username', 21), ('Password') : findTestData('Datatable').getValue('Password', 1)], 
    FailureHandling.STOP_ON_FAILURE)
