 ...
 * PURPOSE: This component is to verify the Page Header in ISPS2
 * REVIEWED BY:
 * REVISION BY:
 * REVISION DATE:
 */
...
modifiedPgHdr = WebUI.modifyObjectProperty(findTestObject('Object Repository/Objects.ReusableObjects/PageHeader'), 'text', 
    'equals', PgHeader, true)
