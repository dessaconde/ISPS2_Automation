...
readBldgWork = WebUI.modifyObjectProperty(findTestObject('Object.AdhocReport/Page_ISPS2/Page_ISPS2/QueryTable'), 'xPath', 
    'equals', ((('(//a[text()="' + extractedCaseTypeFromGV) + '"])[') + Index) + ']', true)
...
CustomKeywords.'com.reusableComponents.HighlightElement.run'(readBldgWork)

'Click the modified object.'
not_run: amount = WebUI.getText(readBldgWork)
