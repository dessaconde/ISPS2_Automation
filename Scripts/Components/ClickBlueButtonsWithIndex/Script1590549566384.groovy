...
complexlyModifiedButtonGG = WebUI.modifyObjectProperty(findTestObject('Objects.ClickBlueButtonsWithXPI/span_Reset'), 'xPath', 
    'equals', ((('(//*[contains(@class,\'x-btn-inner x-btn-inner-default-small\') and (text()=\'' + Button) + '\')])[') + 
    index) + ']', true)

CustomKeywords.'com.reusableComponents.HighlightElement.run'(complexlyModifiedButtonGG)
