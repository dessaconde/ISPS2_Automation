 ...
 * CREATE DATE: 
 * PURPOSE: This is to verify the precision of scale of multi-line textbox
 * ========================================================================
 */
'Hard wait for 3sec'
Thread.sleep(3000)
...
'Verify the Character Length'
switch (GetLenChar) {
    case GlobalVariable.Max4KChar:
        'If it is equal to 4000 maximum character'
        WebUI.verifyEqual(GetLenChar, GlobalVariable.Max4KChar, FailureHandling.STOP_ON_FAILURE)

        break
    case GlobalVariable.Max1KChar:
        'If it is equal to 1000 maximum character'
        WebUI.verifyEqual(GetLenChar, GlobalVariable.Max1KChar, FailureHandling.STOP_ON_FAILURE)
