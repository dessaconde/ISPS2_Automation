...
GridColumnName = WebUI.modifyObjectProperty(findTestObject('Object.AdhocReport/Page_ISPS2/columnSPL_BLDG_WORKS'), 'xPath', 
    'equals', ((('//span[(text() = "' + GlobalVariable.GridColumnName) + '"])[') + Index) + ']', true)
...
CustomKeywords.'com.reusableComponents.HighlightElement.run'(GridColumnName)

'Click the modified object.'
WebUI.click(GridColumnName)
