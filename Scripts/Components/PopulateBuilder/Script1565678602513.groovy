...
'Verify that the user is in the \'Builder\' page; locates the \'Builder\' header. '
CustomKeywords.'com.reusableComponents.HighlightElement.run'(findTestObject('Objects.PopulateBuilder/Page_ISPS2/div_Contractor'))
...
CustomKeywords.'com.reusableComponents.HighlightElement.run'(findTestObject('Objects.PopulateBuilder/Page_ISPS2/input__uenNo'))

'Dynamically populates the \'UEN\' field with a value sourcing from the Datatable. '
WebUI.setText(findTestObject('Objects.PopulateBuilder/Page_ISPS2/input__uenNo'), UEN)
