...
WebUI.callTestCase(findTestCase('Components/PopulateAddress'), [('HouseBlockNo') : '12', ('BuildingName') : 'JMT Building'
        , ('Level') : '11', ('Unit') : 'B', ('PostalCode') : '001800', ('RoadName') : 'ACCESS ROAD (ACC00Y)'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyAddressInSummaryPage'), [('formattedAdd') : 'ACCESS ROAD', ('unformattedAdd') : '3791 Jalan Bukit Merah#06-18 E-Centre @ Redhill Singapore 159471'], 
    FailureHandling.STOP_ON_FAILURE)
