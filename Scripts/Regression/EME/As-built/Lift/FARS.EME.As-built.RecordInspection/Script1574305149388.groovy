...
'Manipulate Record Inspection Attached Plans tab.'
not_run: WebUI.callTestCase(findTestCase('Components/ManipulateRecordInspectionAttachedPlans'), [('remarks') : 'Record Inspection Attached Plans Testing 1'
...
'Click Cancel'
not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'Cancel', ('Index') : 3], 
    FailureHandling.STOP_ON_FAILURE)

'Verify the saved records were present in the page.'
not_run: WebUI.callTestCase(findTestCase('Components/VerifyManipulateRecordInspectionAttachedPlans'), [:], FailureHandling.STOP_ON_FAILURE)
