...
WebUI.callTestCase(findTestCase('Components/VerifyQualifiedPersonV2'), [:], FailureHandling.STOP_ON_FAILURE)

'Verify the existence of the added qp.'
not_run: WebUI.callTestCase(findTestCase('Components/VerifyQualifiedPersonV2'), [('qpSecInSummary') : 'QUALIFIED PERSON FOR SUBMISSION OF THE PLANS FOR LIFT WORKS'], 
