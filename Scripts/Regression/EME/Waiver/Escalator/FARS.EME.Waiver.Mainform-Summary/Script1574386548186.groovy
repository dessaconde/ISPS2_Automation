...
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Supporting structure (truss) and enclosure'
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Steps, pallets, belt'
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Drive unit', ('provisionMadeOn') : 'Plan'
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Balustrade', ('provisionMadeOn') : 'Site'
        , ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Handrail system', ('provisionMadeOn') : 'Plan'
        , ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Landings', ('provisionMadeOn') : 'Site'
        , ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Machinery spaces, driving station and return stations'
        , ('provisionMadeOn') : 'Plan', ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Fire protection', ('provisionMadeOn') : 'Site'
        , ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Transportation', ('provisionMadeOn') : 'Plan'
        , ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Electrical installations and appliances'
        , ('provisionMadeOn') : 'Site', ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Protection against electric fault controls'
        , ('provisionMadeOn') : 'Plan', ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Adds a record in the \'Regulatory Requirement\' table!'
WebUI.callTestCase(findTestCase('Components/NewRegulatoryRequirement'), [('categoryOfProvision') : 'Signals and warning devices'
        , ('provisionMadeOn') : 'Site', ('regulationClause') : '\'Regulation/Clause\' automated populate test. ', ('Description') : '\'Description\' automated populate test. '], 
    FailureHandling.STOP_ON_FAILURE)
