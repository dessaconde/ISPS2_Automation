...
'Filter out Process Waiver Application cases.'
...
'Select Process Waiver Application case type.'
...
not_run: WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Summary'], FailureHandling.STOP_ON_FAILURE)

'Verify address in summary page.'
not_run: WebUI.callTestCase(findTestCase('Components/VerifyAddressInSummaryPage'), [('formattedAdd') : 'ACCESS ROAD', ('unformattedAdd') : '3791 Jalan Bukit Merah#06-18 E-Centre @ Redhill Singapore 159471'], 
    FailureHandling.STOP_ON_FAILURE)

'Navigate to Address LHS.'
not_run: WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Address'], FailureHandling.STOP_ON_FAILURE)
