...
'Navigate to Qualified Person (Submission) LHS.'
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Qualified Person (Submission)'], FailureHandling.STOP_ON_FAILURE)
