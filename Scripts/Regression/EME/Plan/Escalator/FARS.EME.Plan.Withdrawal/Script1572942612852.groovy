...
'Populate withdrawal lhs'
WebUI.callTestCase(findTestCase('Components/ManipulateWithdrawal'), [('remarks') : 'Populate Withdrawal remarks test.', ('withdrawalStatus') : 'Approved'
        , ('generatedLetterContains') : 'EME05350', ('letterToGenerateContains') : 'EME05350'], FailureHandling.STOP_ON_FAILURE)
