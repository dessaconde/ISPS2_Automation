...
'Populate recommend lhs'
WebUI.callTestCase(findTestCase('Components/PopulateRecommendAssignLHS'), [('recommendStatus') : 'Recommend Approval', ('recommendToModule') : ''
...
WebUI.callTestCase(findTestCase('Components/CaseReassignedIsInTray'), [('taskDescription') : 'Process EME Plan Recommendation'], 
    FailureHandling.STOP_ON_FAILURE)
