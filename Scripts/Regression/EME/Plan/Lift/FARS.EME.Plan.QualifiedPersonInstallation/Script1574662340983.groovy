...
'Navigate to Qualified Person (Installation) LHS.'
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Qualified Person (Installation)'], FailureHandling.STOP_ON_FAILURE)
