...
WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'Withdrawal'], FailureHandling.STOP_ON_FAILURE)
...
'Populate withdrawal lhs'
not_run: WebUI.callTestCase(findTestCase('Components/PopulateWithdrawal'), [('remarks') : 'Populate Withdrawal remarks test.'
        , ('withdrawalStatus') : 'Disapproved'], FailureHandling.STOP_ON_FAILURE)

'Manipulate type of letter'
not_run: WebUI.callTestCase(findTestCase('Components/ManipulateTypeOfLetterV3'), [('generatedletterContains') : 'EME05350'
        , ('letterToGenerateContains') : 'EME05350'], FailureHandling.STOP_ON_FAILURE)

'Manipulate type of letter'
not_run: WebUI.callTestCase(findTestCase('Components/ManipulateTypeOfLetterV3'), [('generatedletterContains') : 'EME05620'
        , ('letterToGenerateContains') : 'EME05620'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ManipulateWithdrawal'), [('remarks') : 'Populate Withdrawal remarks test.'
        , ('withdrawalStatus') : 'Disapproved'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ManipulateWithdrawal'), [('remarks') : 'Populate Withdrawal remarks test.', ('withdrawalStatus') : 'Disapproved'
        , ('generatedLetterContains') : 'EME05620', ('letterToGenerateContains') : 'EME05620'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/ManipulateRecipients'), [('addedEmailAddress') : 'automation1@testing.com', ('inputRecipient') : 'Singapore Land Authority'
        , ('addedEmailAddressCC') : 'automation2@testing.com', ('inputRecipientCC') : 'HDBCS'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStatusInUniversalSearch'), [('caseTypeCaseStatus') : 'EME Plan Approval || CLOSED'
        , ('caseStatus') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStageFromUniversalSearch'), [('caseOptions') : 'View Case Stages', ('applicationType') : 'EME Plan Approval'
        , ('officer') : GlobalVariable.null, ('stageDesc') : GlobalVariable.null, ('caseStat') : ''], FailureHandling.STOP_ON_FAILURE)
