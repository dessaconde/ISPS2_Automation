...
//import static com.kms.katalon.core.testobject.ObjectRepository.findObject
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStageFromUniversalSearch'), [('caseOptions') : 'View Case Stages', ('applicationType') : 'EME Plan Approval'
        , ('officer') : 'Michelle Gorczany', ('stageDesc') : 'Issued Written Directions', ('caseStat') : 'ISSUED WRITTEN DIRECTIONS'], 
    FailureHandling.STOP_ON_FAILURE)
