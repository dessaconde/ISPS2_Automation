...
WebUI.callTestCase(findTestCase('Components/PopulateAddress'), [('HouseBlockNo') : '19', ('BuildingName') : 'The JMT Corporate Condominium'
        , ('Level') : '11', ('Unit') : 'B', ('PostalCode') : '002600', ('RoadName') : 'BULIM STREET (BUS25)'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/PopulateAddress'), [('HouseBlockNo') : '12', ('BuildingName') : 'The Podium'
        , ('Level') : '11', ('Unit') : 'B', ('PostalCode') : '002601', ('RoadName') : 'BULIM STREET (BUS25)'], FailureHandling.STOP_ON_FAILURE)
...
'Manipulate and populate all the fields in the Address section.'
WebUI.callTestCase(findTestCase('Components/PopulateAddress'), [('HouseBlockNo') : '19', ('BuildingName') : 'The JMT Corporate Condominium'
        , ('Level') : '11', ('Unit') : 'A', ('PostalCode') : '002600', ('RoadName') : 'BULIM STREET (BUS25)'], FailureHandling.STOP_ON_FAILURE)
