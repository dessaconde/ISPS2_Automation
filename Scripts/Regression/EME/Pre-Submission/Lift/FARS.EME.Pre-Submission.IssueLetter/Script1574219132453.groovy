...
WebUI.callTestCase(findTestCase('Components/ManipulateTypeOfLetterV3'), [('generatedletterContains') : 'EME05180', ('letterToGenerateContains') : 'EME05180'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyCaseStatusInUniversalSearch'), [('caseTypeCaseStatus') : 'EME Pre-Submission Consultation || CLOSED'
        , ('caseStatus') : 'ISSUE PRE CONSULTATION LETTER'], FailureHandling.STOP_ON_FAILURE)

'Universal Search'
WebUI.callTestCase(findTestCase('Components/VerifyCaseStageFromUniversalSearch'), [('caseOptions') : 'View Case Stages', ('applicationType') : 'EME Pre-Submission Consultation'
        , ('officer') : 'Michelle Gorczany', ('stageDesc') : 'Issue Pre Consultation Letter', ('caseStat') : 'ISSUE PRE CONSULTATION LETTER'], 
    FailureHandling.STOP_ON_FAILURE)
