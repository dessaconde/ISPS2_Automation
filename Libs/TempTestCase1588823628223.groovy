...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.CourtActionsLHS\\20200507_115343\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('Components/VerifyTextPresentInPage'), [('tagToModify') : 'div', ('textToModify') : 'Complaint and Charge Sheet'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ScrollPageDown'), [('textToBeUsed') : 'Delete', ('tagToBeUsed') : 'span'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'Reset', ('Index') : '3'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'Save', ('Index') : '1'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ScrollPageDown'), [('textToBeUsed') : 'Complaint and Charge Sheet', ('tagToBeUsed') : 'div'], 
    FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DataErrorValidation'), [('FldNm') : 'courtNo'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DataErrorValidation'), [('FldNm') : 'orderDt'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DataErrorValidation'), [('FldNm') : 'complaintOfficer'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/NumericTextboxValidation'), [('tagToBeUsed') : 'input'
        , ('nameToBeUsed') : 'courtNo'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'orderDt'
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DropdownValidation'), [('FldNm') : 'complaintOfficer'
        , ('NoOfOpt') : 5], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/MultilineTextboxValidation'), [('tagToBeUsed') : 'textarea'
        , ('nameToBeUsed') : 'caseGrpDesc'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DropdownValidation'), [('FldNm') : 'orderTypeCd'
        , ('NoOfOpt') : 9], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/NumericTextboxValidation'), [('tagToBeUsed') : 'input'
        , ('nameToBeUsed') : 'bldgGrpId'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'complaintDt'
        , ('textToBeInputted') : '22/23/2020'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DataErrorValidation'), [('FldNm') : 'complaintDt'], 
    FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'To..', ('Index') : '1'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ClickLinkDependingOnTagTextAndIndex'), [('tagToBeUsed') : 'div', ('linkName') : 'Public Utilities Board - Drainage Department'
        , ('index') : '1'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ClickLinkDependingOnTagTextAndIndex'), [('tagToBeUsed') : 'div', ('linkName') : 'Ministry of the Environment - Pollution Control Department'
        , ('index') : '1'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'OK', ('Index') : '1'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'Save', ('Index') : '1'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/ScrollPageDown'), [('textToBeUsed') : 'li', ('tagToBeUsed') : 'Created Successfully!'], 
    FailureHandling.STOP_ON_FAILURE)
