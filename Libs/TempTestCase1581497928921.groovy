...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19033-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Components\\IntoTheUnknown\\20200212_165848\\execution.properties')
...
modifiedTag = WebUI.modifyObjectProperty(findTestObject('Objects.IntoTheUnknown/objectToModify'), 'tag', 'equals', tagToModify, 
    false)

modified = WebUI.modifyObjectProperty(findTestObject('Objects.IntoTheUnknown/objectToModify'), 'text', 'equals', textToModify, 
    false)
...
WebUI.verifyElementPresent(findTestObject('Objects.IntoTheUnknown/objectToModify'), 0)

not_run: WebUI.verifyElementText(complexlyModifiedButtonGG, textToModify)
