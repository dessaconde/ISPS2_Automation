...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\Process Case (PFI)\\PFI.MainForm\\20200730_162208\\execution.properties')
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'div', ('textToModify') : 'Building Details'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFIHeaderHashmap'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : ''
        , ('textToModify') : '', ('Name') : '', ('CallTCName') : ''], FailureHandling.STOP_ON_FAILURE)
