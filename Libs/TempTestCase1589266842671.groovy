...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19023-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.KIVLHS\\20200512_150038\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'KIV'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/ExpDateValidation'), [('LblNm') : 'KIV Case Due Date *:'
        , ('index') : 1, ('idx') : 3, ('MinLen') : 5], FailureHandling.STOP_ON_FAILURE)
...
''', 'Test Cases/PFI Precision and Scale/PFI Test Cases/PFI.KIVLHS', new TestCaseBinding('Test Cases/PFI Precision and Scale/PFI Test Cases/PFI.KIVLHS',[:]), FailureHandling.STOP_ON_FAILURE , false)
