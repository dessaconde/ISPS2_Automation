...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\Process Case (PFI)\\PFI.MainForm\\20200730_174331\\execution.properties')
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'span', ('textToModify') : 'FI Registration Number *:'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFILabelHashmap'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'span', ('textToModify') : 'Name of Facade Inspector:'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFILabelHashmap'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'span', ('textToModify') : 'Handphone No:'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFILabelHashmap'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'span', ('textToModify') : 'Type of Building:'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFILabelHashmap'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyNameValues'), [('tagToModify') : 'span', ('textToModify') : 'Building Facade Condition:'
        , ('Name') : 'MainForm', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/PFILabelHashmap'], 
    FailureHandling.STOP_ON_FAILURE)
