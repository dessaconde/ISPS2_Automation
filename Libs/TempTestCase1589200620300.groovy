...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19023-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Components\\00_Precision and Scale\\0_PFI\\EOTRequest\\20200511_203655\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('Components/NavigateToAnyLHS'), [('LHS') : 'EOT Request'], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/DateValidation'), [('LblNm') : 'EOT From Date *:'
        , ('FldNm') : 'eotFromDate', ('MinLen') : 5, ('index') : 1, ('PastDtValidation') : 'N'], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/DateValidation'), [('LblNm') : 'EOT To Date *:'
        , ('FldNm') : 'eotToDate', ('MinLen') : 10, ('index') : 2, ('PastDtValidation') : 'Y'], FailureHandling.STOP_ON_FAILURE)

'Verify precision and scale of Approve Officer field'
not_run: WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/OfficerValidation'), [('LblNm') : 'Approve Officer *:'
...
WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/RemarksValidation'), [('LblNm') : 'Remarks *:', ('FldNm') : 'remarks'
        , ('LblPresent') : 'Y', ('RqdFld') : 'Y', ('Minlen') : 10, ('MaxLen') : 4005], FailureHandling.STOP_ON_FAILURE)
