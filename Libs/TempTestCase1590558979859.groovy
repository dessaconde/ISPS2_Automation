...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19023-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.WrittenDirectionsLHS\\20200527_135615\\execution.properties')
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components with Indexing/VerifyDropdownValuesIndex'), [('FldNm') : 'periodType'
        , ('index') : 3, ('CallTCName') : 'PFI Precision and Scale/PFI Components/ConstantHashMap', ('cmbNm') : 'PeriodType'
...
WebUI.callTestCase(findTestCase('Components/HighlightInputIndexField'), [('InputName') : 'expiryDate', ('index') : 3], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components with Indexing/SelectTodayInDatePickerIndex'), [('FldNm') : 'expiryDate'
        , ('index') : 1, ('idx') : 3], FailureHandling.STOP_ON_FAILURE)
