...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.SiteInspectionLHS\\20200512_171036\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CounterValidation'), [('indexUp') : '1'
        , ('secondsToHoldUp') : 10, ('indexDown') : '1', ('secondsToHoldDown') : 10], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CounterValidationII'), [('indexDown') : '1', ('secondsToHoldDown') : 10], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CounterValidation'), [('indexUp') : '2'
        , ('secondsToHoldUp') : 10, ('indexDown') : '2', ('secondsToHoldDown') : 10], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CommonComboBox'), [('FldNm') : 'inspModule', ('NoOfOpt') : 5], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CommonComboBox'), [('FldNm') : 'inspCaseType', ('NoOfOpt') : 1], 
    FailureHandling.STOP_ON_FAILURE)
