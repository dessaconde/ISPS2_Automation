...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.SiteInspectionLHS\\20200512_154917\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CommonComboBox'), [('FldNm') : 'inspModule'
        , ('NoOfOpt') : 5], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CommonComboBox'), [('FldNm') : 'inspCaseType'
        , ('NoOfOpt') : 7], FailureHandling.STOP_ON_FAILURE)

'Verify that the field accepts numeric values.'
not_run: WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'inspDt'
...
'Verify that the field accepts numeric values.'
not_run: WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'inspToDt'
        , ('textToBeInputted') : '22/23/2020'], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/AlphaNumericSpecialTextboxValidationII'), 
    [('labelToBeUsed') : 'Notes:', ('nameToBeUsed') : 'notes', ('minLen') : 10, ('maxLen') : 4000], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CounterValidationUp'), [('indexUp') : '1'
        , ('secondsToHoldUp') : 10, ('indexDown') : '1', ('secondsToHoldDown') : 10], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/CounterValidationDown'), [('indexDown') : '1', ('secondsToHoldDown') : 10], 
    FailureHandling.STOP_ON_FAILURE)
