...
RunConfiguration.setExecutionSettingFile('C:\\Users\\20008-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\Process Case (PFIA)\\PFIA.SiteAuditReport\\20200601_180733\\execution.properties')
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/DataErrorValidationII'), [('textToBeVerified') : 'Auto Update Building Records? '], 
    FailureHandling.STOP_ON_FAILURE)
...
'Verify that only numeric characters can be typed in EOT From Date field'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/NumericTextboxValidationII'), [('nameToBeUsed') : 'rptSubmDt'
        , ('minLen') : 15, ('index') : 1], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/SelectAllThenDeleteIndex'), [('nameToBeUsed') : 'rptSubmDt', ('index') : '1'], 
    FailureHandling.STOP_ON_FAILURE)

'Select any day from the EOT To Date picker'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components with Indexing/SelectDayInDatePickerWithIndex'), 
    [('FldNm') : 'rptSubmDt', ('SelectCurrentDay') : '27', ('index') : 1], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyTextPresentInPage'), [('tagToModify') : 'div', ('textToModify') : 'Building 20 years or older'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/ClickRadioButton'), [('Index') : '3'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/VerifyTextPresentInPage'), [('tagToModify') : 'div', ('textToModify') : 'One Page Report (OPR) / Frequent PE Submission Details'], 
    FailureHandling.STOP_ON_FAILURE)
