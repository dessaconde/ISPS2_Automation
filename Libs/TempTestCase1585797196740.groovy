...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19033-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Jira\\BP\\Process BP Application\\BCAISPS-14707\\BCAISPS-14707.TCID001\\20200402_111311\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'regulationCd'
        , ('textToBeInputted') : 'CHAPTER 2 PROVISIONS'], FailureHandling.STOP_ON_FAILURE)

'Send Enter key.'
not_run: WebUI.callTestCase(findTestCase('Components/SendEnterKey'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'regulationCd'], 
    FailureHandling.STOP_ON_FAILURE)

'Tick any among the checkboxes.'
not_run: WebUI.callTestCase(findTestCase('Components/ClickCheckboxII'), [('Index') : '1'], FailureHandling.STOP_ON_FAILURE)
...
'Saved successfully.'
not_run: WebUI.callTestCase(findTestCase('Components/VerifySuccessfulSavedChanges'), [:], FailureHandling.STOP_ON_FAILURE)

'Click Back button.'
not_run: WebUI.callTestCase(findTestCase('Components/ClickBlueButtonsWithXPI'), [('Button') : 'Back', ('Index') : '1'], 
    FailureHandling.STOP_ON_FAILURE)
...
'Tick any among the checkboxes.'
WebUI.callTestCase(findTestCase('Components/ClickCheckboxII'), [('Index') : '4'], FailureHandling.STOP_ON_FAILURE)

'Populate mandatory fields.'
WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'input', ('nameToBeUsed') : 'regulationCd'
        , ('textToBeInputted') : 'C HEADROOM'], FailureHandling.STOP_ON_FAILURE)
...
'Populate mandatory fields.'
WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'textarea', ('nameToBeUsed') : 'locId', ('textToBeInputted') : 'sample location'], 
    FailureHandling.STOP_ON_FAILURE)

'Populate mandatory fields.'
WebUI.callTestCase(findTestCase('Components/SetTextOnField'), [('tagToBeUsed') : 'textarea', ('nameToBeUsed') : 'modId', ('textToBeInputted') : 'sample modification'], 
    FailureHandling.STOP_ON_FAILURE)
...
'Verify the regulation was saved successfully.'
WebUI.callTestCase(findTestCase('Components/VerifySuccessfulSavedChanges'), [:], FailureHandling.STOP_ON_FAILURE)

''', 'Test Cases/Jira/BP/Process BP Application/BCAISPS-14707/BCAISPS-14707.TCID001', new TestCaseBinding('Test Cases/Jira/BP/Process BP Application/BCAISPS-14707/BCAISPS-14707.TCID001',[:]), FailureHandling.STOP_ON_FAILURE , false)
