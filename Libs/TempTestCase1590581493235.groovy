...
RunConfiguration.setExecutionSettingFile('C:\\Users\\19023-~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI.UpdateReportsLHS\\20200527_201128\\execution.properties')
...
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/RequiredFieldValidation'), [('FldNm') : 'dFormCode'], 
    FailureHandling.STOP_ON_FAILURE)

'Verify data error q-tip.'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/RequiredFieldValidation'), [('FldNm') : 'rptRecvDt'], 
    FailureHandling.STOP_ON_FAILURE)

'Verify data error q-tip.'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/RequiredFieldValidation'), [('FldNm') : 'rptTypeCode'], 
    FailureHandling.STOP_ON_FAILURE)

'Verify data error q-tip.'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/RequiredFieldValidation'), [('FldNm') : 'rptComplyDt'], 
    FailureHandling.STOP_ON_FAILURE)

'Verify data error q-tip.'
WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/RequiredFieldValidation'), [('FldNm') : 'submitBy'], 
    FailureHandling.STOP_ON_FAILURE)

'Verify fields in Report list.'
WebUI.callTestCase(findTestCase('Components/00_Precision and Scale/ReportListValidation'), [('FldNm') : 'dFormCode', ('EnterValue') : 'D5'
        , ('NoOfOpt') : 5, ('DropdownNm') : 'DForm'], FailureHandling.STOP_ON_FAILURE)
