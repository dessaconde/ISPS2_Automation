...
RunConfiguration.setExecutionSettingFile('C:\\Users\\JMML-2~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PFI Precision and Scale\\PFI Test Cases\\PFI - Utilities\\Utilities.FacadeInspectorDetails\\20201027_135341\\execution.properties')
...
'Login from ISPS2.'
not_run: WebUI.callTestCase(findTestCase('Components/Login'), [('LinkToBeUsed') : findTestData('Datatable').getValue('URL', 
            22), ('LoginPageTextToBeVerified') : findTestData('Datatable').getValue('HomeBanner', 22), ('Username') : findTestData(
            'Datatable').getValue('Username', 22), ('Password') : findTestData('Datatable').getValue('Password', 22)], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Components/HoverToAnyMenuSelection'), [('MenuSelection') : 'Facade Inspector Details'], 
    FailureHandling.STOP_ON_FAILURE)

'Click Merge Building Groups'
not_run: WebUI.callTestCase(findTestCase('Components/ClickLink'), [('LinkToModify') : 'Facade Inspector Details'], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyFieldsLabel'), [('HeaderLbl') : 'FI Reg No.'
        , ('index') : '1', ('PFIUtil') : 'FacadeInspDet'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyFieldsLabel'), [('HeaderLbl') : 'NRIC'
        , ('index') : '1', ('PFIUtil') : 'FacadeInspDet'], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/VerifyFieldsLabel'), [('HeaderLbl') : 'Name'
        , ('index') : '163', ('PFIUtil') : 'FacadeInspDet'], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/AlphaNumericSpecialInputValidation'), [
        ('FldNm') : 'inspRegNo', ('LenChar') : 10], FailureHandling.STOP_ON_FAILURE)

'Validate 1st field accepts Alpha Numeric and Special characters'
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/AlphaNumericSpecialInputValidation'), [
        ('FldNm') : 'nricName', ('LenChar') : 20], FailureHandling.STOP_ON_FAILURE)

'Validate 1st field accepts Alpha Numeric and Special characters'
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/AlphaNumericSpecialInputValidation'), [
        ('FldNm') : 'name', ('LenChar') : 20], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components with Indexing/VerifyDropdownValuesIndex'), 
    [('FldNm') : 'isActive', ('index') : '1', ('CallTCName') : 'Test Cases/PFI Precision and Scale/HashMap Tables/ActiveIndicatorHashmap'
        , ('cmbNm') : 'IND', ('NoOfVal') : 2, ('DelayTime') : 2, ('EnterValue') : ''], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/MaxCharLengthValidation'), [('FldNm') : 'inspRegNo'
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/MaxCharLengthValidation'), [('FldNm') : 'nricName'
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components/MaxCharLengthValidation'), [('FldNm') : 'name'
        , ('MaxCharLen') : 100], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('PFI Precision and Scale/PFI Components with Indexing/VerifyDropDownValuesinDB'), 
    [('FldNm') : 'sal', ('index') : 1, ('NoOfVal') : 9, ('DelayTime') : 2, ('ColNm') : 'NAME', ('DBTbl') : 'PV_CODE_EXT'
        , ('Condition1') : 'CATEGORY = \\'SAL_PFI\\' AND NAME ='], FailureHandling.STOP_ON_FAILURE)
...
''', 'Test Cases/PFI Precision and Scale/PFI Test Cases/PFI - Utilities/Utilities.FacadeInspectorDetails', new TestCaseBinding('Test Cases/PFI Precision and Scale/PFI Test Cases/PFI - Utilities/Utilities.FacadeInspectorDetails',[:]), FailureHandling.STOP_ON_FAILURE , false)
